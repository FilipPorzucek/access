...
@Component({
  ...
  <div class="text-blue-600 mt-10 text-m ">LICZBA PRZY ZADANIU OZNACZA GODZINE DO KTOREJ MOZESZ JE WYKONAĆ<br>
JEJ BRAK OZNACZA ŻE ZADANIE NIE MA LIMITU GODZINY</div>
